                        ...
                        <form action="/add-cart" method="post">
                            ...
                            <div class="product-fruits__infos">
                                ...
                                <div>
                                    ...
                                    @auth
                                        <button type="submit"
                                            class="button-add-product button-add-product btn-add-cart button-add-product--view">Cho
                                            vào giỏ</button>
                                    @endauth
                    ...
                    <div class="col col-lg-3 col-md-6 col-sm-6 col-6 isotope-item women">
                        <div class="col-product__item sale-home product-item__sale-off--none">
                            <form action="/add-cart" method="POST">
                                ...
                                <div class="product-img">
                                    <a
                                        href="/san-pham/{{ $product->menu_id }}-{{ $product->id }}-{{ Str::slug($product->name, '-') }}.html">
                                        <span class="img--hover"></span>
                                        <img src="{{ $product->thumb }}" alt="{{ $product->name }}">
                                    </a>
                                    <p class="text-sale">Sale</p>
